...
import com.cp.tencentlivesimple.call.model.impl.TRTCCallingImpl;
    ...
    public void onCreate() {
        ...
        V2TIMManager.getInstance().login(userId, userSig, new V2TIMCallback() {
            ...
            public void onError(int i, String s) {
                // 登录IM失败
                Toast.makeText(CallService.this, "登录失败", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSuccess() {
                //1. 登录IM成功
                Toast.makeText(CallService.this, "登录成功", Toast.LENGTH_SHORT).show();
//                initTRTCCallingData();
                initLiveRoom();
//                initMeetingData();
//                initVoiceRoom();
