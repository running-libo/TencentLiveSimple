package com.cp.tencentlivesimple.model.impl;
...
import com.cp.tencentlivesimple.model.impl.av.liveplayer.TXLivePlayerRoom;
import com.cp.tencentlivesimple.model.impl.av.trtc.ITXTRTCLiveRoomDelegate;
import com.cp.tencentlivesimple.model.impl.av.trtc.TXTRTCLiveRoom;
import com.cp.tencentlivesimple.model.impl.av.trtc.TXTRTCMixUser;
import com.cp.tencentlivesimple.model.impl.base.TRTCLogger;
import com.cp.tencentlivesimple.model.impl.base.TXCallback;
import com.cp.tencentlivesimple.model.impl.base.TXRoomInfo;
import com.cp.tencentlivesimple.model.impl.base.TXRoomInfoListCallback;
import com.cp.tencentlivesimple.model.impl.base.TXUserInfo;
import com.cp.tencentlivesimple.model.impl.base.TXUserListCallback;
import com.cp.tencentlivesimple.model.impl.room.ITXRoomServiceDelegate;
import com.cp.tencentlivesimple.model.impl.room.impl.TXRoomService;
...
import static com.cp.tencentlivesimple.model.TRTCLiveRoomDef.ROOM_STATUS_NONE;
import static com.cp.tencentlivesimple.model.TRTCLiveRoomDef.ROOM_STATUS_PK;
...
public class TRTCLiveRoomImpl extends TRTCLiveRoom implements ITXTRTCLiveRoomDelegate, ITXRoomServiceDelegate {
    ...
    private void changeToTRTCPlay() {
        ...
        for (String userId : mAnchorList) {
            TXTRTCLiveRoom.getInstance().startPlay(userId, mPlayViewMap.get(userId), new TXCallback() {
                @Override
                public void onCallback(int code, String msg) {
